(function ($) {
  ...
  --------------------------------------------------------------*/
    ...
    if ($(".listing-one-tabs-box").length) {
        $(".listing-one-tabs-box .listing-one-tab-btns .p-tab-btn").on(
            "click",
            function (e) {
                e.preventDefault();
                ...
                if ($(target).hasClass("actve-tab")) {
                    ...
                    $(
                        ".listing-one-tabs-box .listing-one-tab-btns .p-tab-btn"
                    ).removeClass("active-btn");
                    $(this).addClass("active-btn");
                    $(
                        ".listing-one-tabs-box .p-tabs-content .p-tab"
        ...
        $(".product__all-tab .tabs-button-box .tab-btn-item").on(
            ...
            function (e) {
                ...
                if ($(target).hasClass("actve-tab")) {
                    ...
                    $(
                        ".product__all-tab .tabs-button-box .tab-btn-item"
