...
Route::middleware('auth:web')->group(function () {
    ...
    Route::get('/booking/failed', [App\Http\Controllers\BookingController::class, 'failed'])->name('booking.failed');
    ...
    Route::post('/payment/client-confirm', [App\Http\Controllers\MidtransController::class, 'clientCallback'])->name('payment.client_confirm');
