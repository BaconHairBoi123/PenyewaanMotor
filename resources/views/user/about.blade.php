                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms"
                        ...
                        <div class="services-one__single">
                            ...
                            <p class="services-one__text">kita memiliki motor yang exclusive yang bisa anda sewa selama anda liburan atau tinggal di bali</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="500ms"
                        ...
                        <div class="services-one__single">
                            ...
                            <p class="services-one__text">kita memberikan kelas untuk wisatawan yang belum lihay menggunakan motor</p>
                        </div>
                    </div>
                    <!--Services One Single End-->
                    <!--Services One Single Start-->
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="700ms"
                        ...
                        <div class="services-one__single">
                            ...
                            <p class="services-one__text">kita menyediakan aksesoris tambahan untuk kelengkapan berkendara si pengguna</p>
                        </div>
                    </div>
                    <!--Services One Single End-->
                </div>
            ...
            <div class="container">
                <div class="section-title text-center sec-title-animation animation-style1">
                    <div class="section-title__tagline-box justify-content-center">
                        ...
                        <span class="section-title__tagline">Checkout our new Motorcyle</span>
                    </div>
                    <h2 class="section-title__title title-animation">Explore Most Popular Motorcyle</h2>
                </div>
                <div class="listing-one__tab-box listing-one-tabs-box">
                    <ul class="listing-one-tab-buttons listing-one-tab-btns clearfix list-unstyled">
                        <li data-tab="#honda" class="p-tab-btn active-btn"><span>honda</span></li>
                        <li data-tab="#yamaha" class="p-tab-btn"><span>yamaha</span></li>
                        <li data-tab="#ducati" class="p-tab-btn"><span>ducati</span></li>
                        <li data-tab="#kawasaki" class="p-tab-btn"><span>kawasaki</span></li>
                        <li data-tab="#harley davidson" class="p-tab-btn"><span>harley davidson</span></li>
                        <li data-tab="#vespa" class="p-tab-btn"><span>vespa</span></li>
                    </ul>
                    <div class="p-tabs-content">
                        <!--tab-->
                        <div class="p-tab active-tab" id="honda">
                            <div class="listing-one__inner">
                                <div class="listing-one__carousel owl-carousel owl-theme">
                                    ...
                                    <div class="item">
                                        <div class="listing-one__single">
                                            <div class="listing-one__img">
                                                <img src="{{ asset('assets/images/backgrounds/turbo.jpg') }}" alt="">
                                                <div class="listing-one__brand-name">
                                                    <p>YAMAHA</p>
                                                </div>
                                            </div>
                                            <div class="listing-one__content">
                                                <h3 class="listing-one__title"><a href="listing-single.html">nmax
                                                       turbo 155</a></h3>
                                    ...
                                    <div class="item">
                                        <div class="listing-one__single">
                                            <div class="listing-one__img">
                                                <img src="{{ asset('assets/images/backgrounds/pcx.jpg') }}" alt="">
                                                <div class="listing-one__brand-name">
                                                    <p>HONDA</p>
                                                </div>
                                            </div>
                                            <div class="listing-one__content">
                                                <h3 class="listing-one__title"><a href="listing-single.html">pcx 160</a></h3>
                                                <div class="listing-one__meta-box-info">
                                                    <ul class="list-unstyled listing-one__meta">
                                                        <li>
                                                            <div class="icon">
                                    ...
                                    <div class="item">
                                        <div class="listing-one__single">
                                            <div class="listing-one__img">
                                                <img src="{{ asset('assets/images/backgrounds/SPORTERS.jpg') }}" alt="">
                                                <div class="listing-one__brand-name">
                                                    <p>Harley Davidson</p>
                                                </div>
                                            </div>
                                            <div class="listing-one__content">
                                                <h3 class="listing-one__title"><a href="listing-single.html">Sportster S 2025</a></h3>
                                                <div class="listing-one__meta-box-info">
                                                    <ul class="list-unstyled listing-one__meta">
                                                        <li>
                                                            <div class="icon">
                                    ...
                                    <div class="item">
                                        <div class="listing-one__single">
                                            <div class="listing-one__img">
                                                <img src="{{ asset('assets/images/backgrounds/vespa.jpeg') }}" alt="">
                                                <div class="listing-one__brand-name">
                                                    <p>vespa piagio</p>
                                                </div>
                                            </div>
                                            <div class="listing-one__content">
                                                <h3 class="listing-one__title"><a href="listing-single.html">vespa primavera 2024</a></h3>
                                                <div class="listing-one__meta-box-info">
                                                    <ul class="list-unstyled listing-one__meta">
                                                        <li>
                                                            <div class="icon">
                                    ...
                                    <div class="item">
                                        <div class="listing-one__single">
                                            <div class="listing-one__img">
                                                <img src="{{ asset('assets/images/backgrounds/exmek.jpg') }}" alt="">
                                                <div class="listing-one__brand-name">
                                                    <p>YAMAHA</p>
                                                </div>
                                            </div>
                                            <div class="listing-one__content">
                                                <h3 class="listing-one__title"><a href="listing-single.html">xmax 250 2024</a></h3>
                                                <div class="listing-one__meta-box-info">
                                                    <ul class="list-unstyled listing-one__meta">
                                                        <li>
                                                            <div class="icon">
                                    ...
                                    <div class="item">
                                        <div class="listing-one__single">
                                            <div class="listing-one__img">
                                                <img src="{{ asset('assets/images/backgrounds/itali.jpg') }}" alt="">
                                                <div class="listing-one__brand-name">
                                                    <p>ducati</p>
                                                </div>
                                            </div>
                                            <div class="listing-one__content">
                                                <h3 class="listing-one__title"><a href="listing-single.html">panigle v4 2025</a></h3>
                                                <div class="listing-one__meta-box-info">
                                                    <ul class="list-unstyled listing-one__meta">
                                                        <li>
                                                            <div class="icon">
                                    ...
                                    <div class="item">
                                        <div class="listing-one__single">
                                            <div class="listing-one__img">
                                                <img src="{{ asset('assets/images/backgrounds/crf.jpg') }}" alt="">
                                                <div class="listing-one__brand-name">
                                                    <p>Honda</p>
                                                </div>
                                            </div>
                                            <div class="listing-one__content">
                                                <h3 class="listing-one__title"><a href="listing-single.html">CRF rally 250</a></h3>
                                                <div class="listing-one__meta-box-info">
                                                    <ul class="list-unstyled listing-one__meta">
                                                        <li>
                                                            <div class="icon">
                    ...
                    <div class="item">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3 class="blog-one__title"><a href="blog-details.html">Documents required for motorbike
                                        rental services</a></h3>
                                <p class="blog-one__text">motorbike Is Where Early Adopters And Innovation Seekers Find Lively
                                    Imaginative Tech.</p>
                    ...
                    <div class="item">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3 class="blog-one__title"><a href="blog-details.html">One of the most effective motorbike
                                        rental
                                        blog topic</a></h3>
                                <p class="blog-one__text">motorbike Is Where Early Adopters And Innovation Seekers Find Lively
                                    Imaginative Tech.</p>
                    ...
                    <div class="item">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3 class="blog-one__title"><a href="blog-details.html">Rental motorbike how to check driving
                                        fines?</a></h3>
                                <p class="blog-one__text">motorbike Is Where Early Adopters And Innovation Seekers Find Lively
                                    Imaginative Tech.</p>
                                <a href="blog-details.html" class="blog-one__read-more">Read More <span
