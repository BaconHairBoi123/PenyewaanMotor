...
<head>
    ...
    <title> @yield('title', 'Gorent') || Gorent || Gorent HTML 5 Template </title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    <div class="body-bg-shape" style="background-image: url({{ asset('assets/images/shapes/body-bg-shape.jpg') }});"></div>
