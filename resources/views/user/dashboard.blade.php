...
@section('content')  <!-- Bagian konten halaman home -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="500ms"
                        ...
                        <div class="process-one__single">
                            ...
                            <p class="process-one__text">You can pick it up at our office, or we can deliver it to your requested location.</p>
                        </div>
                    </div>
                    <!-- Process One Single End -->
                    <!-- Process One Single Start -->
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="700ms"
                        ...
                        <div class="process-one__single">
                            ...
                            <p class="process-one__text"></p>Enjoy your trip and stay safe while driving, both for yourself and those around you.</p>
                        </div>
                    </div>
                    <!-- Process One Single End -->
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6">
                                                <div class="booking-one__input-box">
                                                    ...
                                                    <div class="select-box">
                                                        <select class="selectmenu wide">
                                                            <option selected="selected">Your motorbike Type
                                                            </option>
                                                            <option>Your motorbike Type 01</option>
                                                            <option>Your motorbike 02</option>
                                                            <option>Your motorbike 03</option>
                                                            <option>Your motorbike 04</option>
                                                            <option>Your motorbike 05</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="container">
                ...
                <div class="listing-one__tab-box listing-one-tabs-box">
                    <ul class="listing-one-tab-buttons listing-one-tab-btns clearfix list-unstyled">
                        <li data-tab="#nmax-turbo" class="p-tab-btn active-btn"><span>nmax-turbo</span></li>
        ...
        <section class="testimonial-one">
            <div class="container">
                <div class="section-title text-left sec-title-animation animation-style2">
                    ...
                    <h2 class="section-title__title title-animation">What Peoples Say <br> about Ride Nusa</h2>
                </div>
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="download-app-one__content sec-title-animation animation-style2">
                                ...
                                <div class="download-app-one__google-and-app-store">
                                        <a href="contact.html"><img src="{{ asset('assets/images/icon/download-app-img1.png') }}"
                                            alt=""></a>
                                        <a href="contact.html"><img src="{{ asset('assets/images/icon/download-app-img2.png') }}"
                                            alt=""></a>
                                </div>
                            </div>
                        </div>
