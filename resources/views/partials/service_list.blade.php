                ...
                <div class="row align-items-center">
                    <div class="col-md-2 text-center">
                        <img src="{{ asset('storage/' . $motor->image_path) }}" 
                             alt="motor" class="rounded" 
                             style="width: 100%; max-width: 150px; height: 100px; object-fit: cover;">
                    </div>
                    
                    <div class="col-md-7">
                        <h4 class="mb-1 text-uppercase">{{ $motor->brand }} {{ $motor->category }}</h4>
                        <p class="text-muted mb-1">Plat Nomor: <span class="badge bg-dark">{{ $motor->license_plate }}</span></p>
                        <p class="mb-0 text-muted">Status: {{ strtoupper($motor->status) }} | {{ $motor->cc }} CC</p>
                    </div>
